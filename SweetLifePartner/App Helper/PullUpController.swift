...
open class PullUpController: UIViewController {
    ...
    fileprivate func setup(superview: UIView, initialStickyPointOffset: CGFloat, gestureView: UIView) {
        ...
        setupPanGestureRecognizer(gestureView: gestureView)
        setupConstraints()
    ...
    private func setupPanGestureRecognizer(gestureView: UIView) {
...
extension UIViewController {
    ...
    open func addPullUpController(_ pullUpController: PullUpController,
                                  ...
                                  animated: Bool, gestureView: UIView) {
        ...
        pullUpController.setup(superview: view, initialStickyPointOffset: initialStickyPointOffset, gestureView: gestureView)
