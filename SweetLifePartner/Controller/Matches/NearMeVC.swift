...
extension NearMeVC: UITableViewDataSource {
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return UserNameArr.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "NearMeTableCell") as! NearMeTableCell
        cell.lblUserName.text = UserNameArr[indexPath.row]
        return cell
    }
}
// MARK: - Table view delegates methods
extension NearMeVC: UITableViewDelegate {
    
}

//MARK:- Table View Cell Classes
class NearMeTableCell: UITableViewCell {
...
extension NearMeVC : CellDelegate {
